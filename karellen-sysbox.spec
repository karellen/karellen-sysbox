...
%prep
%autosetup
sed -i 's/ -trimpath//g' sysbox/sysbox-runc/Makefile \
                         sysbox/sysbox-fs/Makefile \
                         sysbox/sysbox-mgr/Makefile
cd /tmp
mkdir -p $HOME/.local
wget https://go.dev/dl/go%{golang_version}.linux-%{sys_arch}.tar.gz
rm -rf $HOME/.local/go
tar -C $HOME/.local -xzf go%{golang_version}.linux-%{sys_arch}.tar.gz
...
%changelog
* Tue Sep 15 2026 Karellen Supervisor <supervisor@karellen.co> 0.7.1.5-1
- Update 2026-09-15T20:56:13Z (supervisor@karellen.co)

* Fri Sep 04 2026 Arcadiy Ivanov <arcadiy@ivanov.biz> 0.7.1.4-2
- Bump go and protoc dependencies (arcadiy@ivanov.biz)

* Thu Sep 03 2026 Karellen Supervisor <supervisor@karellen.co> 0.7.1.4-1
- Update 2026-09-03T06:22:16Z (supervisor@karellen.co)

* Wed Aug 26 2026 Karellen Supervisor <supervisor@karellen.co> 0.7.1.2-1
- Update 2026-08-26T00:16:26Z (supervisor@karellen.co)

* Sat Aug 01 2026 Karellen Supervisor <supervisor@karellen.co> 0.7.1.1-1
- Update 2026-08-01T02:50:36Z (supervisor@karellen.co)

* Tue Jul 28 2026 Karellen Supervisor <supervisor@karellen.co> 0.7.0.22-1
- Update 2026-07-28T19:24:28Z (supervisor@karellen.co)
...
* Thu Jun 04 2026 Arcadiy Ivanov <arcadiy@ivanov.biz>
- Disable debugsource on RHEL/EPEL 8 where debugedit cannot handle Go DWARF
  (arcadiy@ivanov.biz)
...
* Thu May 14 2026 Karellen Supervisor <supervisor@karellen.co> 0.7.0.13-1
- Update 2026-05-14T00:52:50Z (supervisor@karellen.co)
...
* Sat Mar 28 2026 Arcadiy Ivanov <arcadiy@ivanov.biz>
- Fix CI: remove broken keepalive workflow, fix K8s image build permissions,
  regenerate patch (arcadiy@ivanov.biz)

* Wed Mar 04 2026 Arcadiy Ivanov <arcadiy@ivanov.biz> 0.7.0.3-2
- Fix patches for 0.7.0 (arcadiy@ivanov.biz)

* Wed Mar 04 2026 Arcadiy Ivanov <arcadiy@ivanov.biz>
- Fix patches for 0.7.0 (arcadiy@ivanov.biz)

* Wed Mar 04 2026 Karellen Supervisor <supervisor@karellen.co> 0.7.0.3-1
- Update 2026-03-04T06:19:41Z (supervisor@karellen.co)

* Wed Mar 04 2026 Karellen Supervisor <supervisor@karellen.co> 0.7.0.2-1
- Update 2026-03-04T00:31:58Z (supervisor@karellen.co)
- Fix workflow keepalive permissions (arcadiy@ivanov.biz)

* Fri Jan 30 2026 Arcadiy Ivanov <arcadiy@ivanov.biz> 0.6.7.32-2
- Bump to latest Golang 1.24 Bump GHA to checkout@v6 Add keep-alive for
  update.yml workflow to prevent it from going dormant (arcadiy@ivanov.biz)

* Fri Jan 30 2026 Karellen Supervisor <supervisor@karellen.co> 0.6.7.32-1
- Update 2026-01-30T19:38:33Z (supervisor@karellen.co)

* Wed Oct 15 2025 Karellen Supervisor <supervisor@karellen.co> 0.6.7.17-1
- Update 2025-10-15T00:17:13Z (supervisor@karellen.co)
- Update actions/checkout [skip ci] (arcadiy@ivanov.biz)

* Sun Aug 31 2025 Karellen Supervisor <supervisor@karellen.co> 0.6.7.15-1
- Update 2025-08-31T00:18:20Z (supervisor@karellen.co)

* Tue Jul 15 2025 Karellen Supervisor <supervisor@karellen.co> 0.6.7.11-1
- Update 2025-07-15T18:05:45Z (supervisor@karellen.co)

* Sat Jul 12 2025 Karellen Supervisor <supervisor@karellen.co> 0.6.7.10-1
- Update 2025-07-12T00:17:21Z (supervisor@karellen.co)
...
* Fri May 16 2025 Arcadiy Ivanov <arcadiy@ivanov.biz>
- Update Golang version (arcadiy@ivanov.biz)

* Sat May 10 2025 Arcadiy Ivanov <arcadiy@ivanov.biz> 0.6.7.4-2
- Fix the patch for pkging (arcadiy@ivanov.biz)
- Update runtime class patching (arcadiy@ivanov.biz)

* Sat May 10 2025 Karellen Supervisor <supervisor@karellen.co> 0.6.7.4-1
- Update 2025-05-10T06:04:45Z (supervisor@karellen.co)

* Sat May 10 2025 Karellen Supervisor <supervisor@karellen.co> 0.6.7.3-1
- Update 2025-05-10T00:15:57Z (supervisor@karellen.co)

* Fri May 09 2025 Karellen Supervisor <supervisor@karellen.co> 0.6.6.29-1
- Update 2025-05-09T18:05:01Z (supervisor@karellen.co)

* Sat May 03 2025 Karellen Supervisor <supervisor@karellen.co> 0.6.6.27-1
- Update 2025-05-03T18:04:48Z (supervisor@karellen.co)

* Tue Apr 22 2025 Karellen Supervisor <supervisor@karellen.co> 0.6.6.26-1
- Update 2025-04-22T00:16:19Z (supervisor@karellen.co)

* Tue Apr 15 2025 Karellen Supervisor <supervisor@karellen.co> 0.6.6.25-1
- Update 2025-04-15T18:04:51Z (supervisor@karellen.co)

* Mon Apr 14 2025 Arcadiy Ivanov <arcadiy@ivanov.biz> 0.6.6.23-2
- Added needed dependency: rsync (dirutigliano20@gmail.com)

* Thu Apr 03 2025 Karellen Supervisor <supervisor@karellen.co> 0.6.6.23-1
- Update 2025-04-03T18:04:58Z (supervisor@karellen.co)

* Mon Feb 10 2025 Arcadiy Ivanov <arcadiy@ivanov.biz> 0.6.6.12-16
- Fixup installation manifests (arcadiy@ivanov.biz)

* Sun Feb 09 2025 Arcadiy Ivanov <arcadiy@ivanov.biz> 0.6.6.12-15
- Do disable userns clone sysctl (arcadiy@ivanov.biz)

* Sun Feb 09 2025 Arcadiy Ivanov <arcadiy@ivanov.biz> 0.6.6.12-14
- Fix installer for DNF systems (arcadiy@ivanov.biz)

* Sun Feb 09 2025 Arcadiy Ivanov <arcadiy@ivanov.biz> 0.6.6.12-13
- More fixes for undeclared variables being referenced (arcadiy@ivanov.biz)

* Sun Feb 09 2025 Arcadiy Ivanov <arcadiy@ivanov.biz> 0.6.6.12-12
- Fix error in K8S Deployer (arcadiy@ivanov.biz)

* Sat Feb 08 2025 Arcadiy Ivanov <arcadiy@ivanov.biz> 0.6.6.12-11
- Try to push combined multiarch image (arcadiy@ivanov.biz)

* Sat Feb 08 2025 Arcadiy Ivanov <arcadiy@ivanov.biz> 0.6.6.12-10
- Use proper token for GHCR (arcadiy@ivanov.biz)
...
* Sat Feb 08 2025 Arcadiy Ivanov <arcadiy@ivanov.biz> 0.6.6.12-7
- Fix syntax error (arcadiy@ivanov.biz)

* Sat Feb 08 2025 Arcadiy Ivanov <arcadiy@ivanov.biz> 0.6.6.12-6
- Fix runner OSes (arcadiy@ivanov.biz)

* Sat Feb 08 2025 Arcadiy Ivanov <arcadiy@ivanov.biz> 0.6.6.12-5
- Build images on x86_64 and arm64 (arcadiy@ivanov.biz)

* Sat Feb 08 2025 Arcadiy Ivanov <arcadiy@ivanov.biz> 0.6.6.12-4
- Checkout recurisve (arcadiy@ivanov.biz)

* Sat Feb 08 2025 Arcadiy Ivanov <arcadiy@ivanov.biz> 0.6.6.12-3
- Recurse into submodules (arcadiy@ivanov.biz)

* Sat Feb 08 2025 Arcadiy Ivanov <arcadiy@ivanov.biz> 0.6.6.12-2
- Add image builder (arcadiy@ivanov.biz)

* Sat Jan 25 2025 Karellen Supervisor <supervisor@karellen.co> 0.6.6.12-1
- Update 2025-01-25T18:03:54Z (supervisor@karellen.co)

* Sat Jan 25 2025 Karellen Supervisor <supervisor@karellen.co> 0.6.6.8-1
- Update 2025-01-25T00:14:21Z (supervisor@karellen.co)

* Fri Jan 24 2025 Karellen Supervisor <supervisor@karellen.co> 0.6.6.7-1
- Update 2025-01-24T06:04:46Z (supervisor@karellen.co)
